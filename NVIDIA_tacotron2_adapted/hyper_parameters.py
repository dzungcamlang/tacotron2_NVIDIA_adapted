...
tacotron_params = {'filter_length': 1024,  # audio parameters:
                   ...
                   'batch_size': 64,  # should be larger than the number of GPUs. Integer multiple of the num. of GPUs
                   'learning_rate': 1e-3,
                   'weight_decay': 1e-6,
                   ...
                   'epochs': 500,
                   'iters_per_checkpoint': 1000,  # How many iterations before validating
                   'seed': 1234,
                   'dynamic_loss_scaling': True,  # CHECK IT OUT!
                   'distributed_run': True,
                   'dist_backend': 'nccl',
                   'dist_url': "/homedtic/apeiro/tacotron2",
                   'cudnn_enabled': True,
